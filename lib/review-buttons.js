...
validateContainer.classList.add("validator");
...
if (window.location.href.indexOf('github.io') !== -1) {
  ...
  const repository = splitHref[2]
    ...
    .filter(str => str !== '')
    .pop();
    const repoUrl = `https://github.com/${userName}/${userName}.github.${repository}`
  /*const repoUrl = `https://github.com/${userName}/${repository}`;
  gives https://github.com/bermarte/io
  while it should be https://github.com/bermarte/bermarte.github.io
  */
